...
* הטמפרטורה בחדר הזה - אם תמדדו בלילה או ביום תקבלו סטטיסטיקות שונות מאוד
...
שאינו רעש הוא ירי של נוירונים במוח שלנו.
...
בהינתן שיש לנו דגימה של האות האקראי והוא סטציונרי וארגודי נוכל להתחיל לחשב
תכונות שלו:
...
* **אותות הספק** - יש להם הספק קבוע בזמן ואנרגיה אינסופית (כי הם על זמן אינסופי)
...
יתפלגו בדיוק באותה צורה בכל זמן. וגם לא שההתפלגות המשותפת תהיה בדיוק זהה בזמנים שונים.
זאת הגדרה הרבה יותר מקלה אבל גם מאוד מאוד שימושית. אנחנו נראה
בהמשך איך פונקציית האוטוקורלציה משחקת תפקיד מרכזי בניתוח של רעשים בתדר.
